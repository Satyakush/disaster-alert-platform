...
export default function CreateAlertForm({ onCreated, selectedRegion }) {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="mb-5"><p className="text-xs font-semibold uppercase tracking-wider text-red-600">Alert operations</p><h2 className="mt-1 text-xl font-bold text-slate-900">Create New Alert</h2><p className="mt-1 text-sm text-slate-500">Select a location on the map, assess the hazard scenario, then publish a structured disaster alert.</p></div>
